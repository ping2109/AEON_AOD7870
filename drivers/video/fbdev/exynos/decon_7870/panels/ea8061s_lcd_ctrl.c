...
static int ea8061s_init(struct lcd_info *lcd)
{
	...
	ea8061s_read_chip_id(lcd);
	ea8061s_read_manufacture_info(lcd);
#endif
...
static int ea8061s_read_init_info(struct lcd_info *lcd, unsigned char *mtp)
{
	...
	ea8061s_read_mtp(lcd, mtp);
	ea8061s_read_coordinate(lcd);
	ea8061s_read_chip_id(lcd);
	ea8061s_read_elvss(lcd, elvss_data);
	ea8061s_read_manufacture_info(lcd);
	ea8061s_init_elvss(lcd, elvss_data);
	ea8061s_init_hbm_elvss(lcd, elvss_data);
	ea8061s_init_hbm_interpolation(lcd);
